...
public class ApiConfig {
    public static final String DEFAULT_BASE_URL = "https://skypaybd.top";
    public static final String PUBLIC_WEBSITE_URL = "https://skypaybd.top";
    public static final String API_VERSION = "v1";
    public static final String LOGIN_ENDPOINT = "/api/device/login";
    public static final String SMS_DATA_ENDPOINT = "/api/device/add/data";
